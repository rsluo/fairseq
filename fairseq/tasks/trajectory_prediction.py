...
from fairseq.data import (
    ...
    MonolingualDataset, TokenBlockDataset, TruncatedDictionary, TrajectoryDataset
)
from fairseq.tasks import FairseqTask, register_task


@register_task('trajectory_prediction')
class TrajectoryPredictionTask(FairseqTask):
    """
    ...
    def load_dataset(self, split):
        ...
        loaded_datasets = []
        loaded_datasets.append(TrajectoryDataset(split_dir, num_input_points, shuffle))
        self.datasets[split] = TrajectoryDataset(split_dir, num_input_points, shuffle)
